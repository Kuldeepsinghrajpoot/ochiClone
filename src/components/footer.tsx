    ...
    return (
        <div className="bg-gray-100 h-screen w-full  text-black " >
            <div className="flex flex-col w-full h-full justify-between ">
                <div className="flex justify-between bg-gray-100 h-screen w-full  text-black">

                    <div className=" h-screen w-full  py-10 line tracking-tighter flex  flex-col  justify-between">
                        <div className="w-full h-full">
                            {['eye-', 'opening'].map((value, key) => (
                                <div key={key} className=" font-bold text-[7rem] uppercase leading-[6rem] tracking-tighter px-20 "><div className="">
                                    {value}</div></div>
                            ))}
                        </div>
                    ...
                    <div className=" h-full w-full  py-10">
                        <div className=" flex flex-col h-full justify-between ">
                            <div className="h-full flex flex-col justify-between">
                                <div className="uppercase  text-left text-[4rem]  font-bold">presentation</div>
                                <div className="">S:
                                    <div className=" ">
                                        {["Instagram", "Behance", "Facebook", "Linkedin"].map((item, key) => (
                                            <div className="border-b-2 w-20 border-black" key={key}>{item}</div>
                                        ))}
                                    </div>
                                </div>
                                <div className=" flex justify-between  w-[40rem]">
                                    <div className="flex flex-col ">
                                        ...
                                        <div className="py-5">
                                            <div className="border-b w-fit border-black">
                                                202-1965 W 4th Ave
                                        ...
                                        <div >
                                            <div className="border-b w-fit  border-black">30 Chukarina St</div>
                                            <div className="border-b w-fit border-black">Lviv, Ukraine</div>
                                        </div>
                                        <div className="py-10">
                                            <div className="py-4">E:</div>
                                            <div className=" w-fit border-b border-black">Email :kuldeep@gmail.com</div>
                                        </div>
                                    </div>
                                    <div>
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div className="w-fit border-b border-black">Services</div>
                                                <div className="w-fit border-b border-black">Our work</div>
                                                <div className="w-fit border-b border-black">About us</div>
                                                <div className="w-fit border-b border-black">Insights</div>
                                                <div className="w-fit border-b border-black"> Contact us</div></div>
                                        </div>
                                    </div>
